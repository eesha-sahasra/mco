...
const DynamicCPU = forwardRef(({ podUsage_new, timePart }, ref) => {
  const [data, setData] = useState([]);
  const [appName, cpuUsage, ,] = podUsage_new;

  useEffect(() => {
    let newDataEntry = {};
    newDataEntry[`${appName}_cpu`] = parseFloat(cpuUsage);
